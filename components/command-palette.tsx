...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    { id: "connect-four", title: "Connect Four", category: "Game", icon: "🔴", path: "/games/connect-four" },
    { id: "hangman", title: "Hangman Word Challenge", category: "Game", icon: "📝", path: "/games/hangman" },
